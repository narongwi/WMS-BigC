...
namespace snaps.wms.api.inbound
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddSingleton<inboundparameterService>();
            ...
            services.AddScoped<IinboundparameterService, inboundparameterService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            logger.LogInformation("Snaps service api of inbound module started " + DateTime.Now + " url: " + Configuration["AppSettings:ApiUrl"]);
        }
    }
}
