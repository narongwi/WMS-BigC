class PrepDetails {
  ...
  PrepDetails.fromJson(Map<String, dynamic> json) {
    dateassign =
        json['dateassign'] == null ? null : DateTime.parse(json["dateassign"]);
    datestart =
    ...
    if (json['lines'] != null) {
      ...
      json['lines'].forEach((v) {
        preplines.add(new PrepLines.fromJson(v));
      });
    }
    setno = json['setno'];
    hutype = json['hutype'];
    ...
    prepno = json['prepno'];
    prepdate =
        json['prepdate'] == null ? null : DateTime.parse(json["prepdate"]);
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dateassign'] =
        this.dateassign != null ? dateassign.toIso8601String() : dateassign;
    data['datestart'] =
    ...
    if (this.preplines != null) {
      data['lines'] = this.preplines.map((v) => v.toJson()).toList();
    }
    ...
    data['prepdate'] =
        this.prepdate != null ? prepdate.toIso8601String() : prepdate;
...
class PrepLines {
  ...
  PrepLines.fromJson(Map<String, dynamic> json) {
    huno = json['huno'];
    ...
    picker = json['picker'];
    datepick =
        json['datepick'] == null ? null : DateTime.parse(json["datepick"]);
  ...
  Map<String, dynamic> toJson() {
    ...
    data['picker'] = this.picker;
    data['datepick'] =
        this.datepick != null ? datepick.toIso8601String() : datepick;
