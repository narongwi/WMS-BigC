...
import { confirmline_md, countcorrection_md, countline_md, countplan_md, counttask_md } from '../models/inv.count.model';
...
export class countService {
    ...
    listTask(o:counttask_md){
        return  this.http.post<counttask_md[]>(environment.urlapiInvt + "/count/listTask/"+this.guid, JSON.stringify(o))
                .pipe( map(res=><counttask_md[]>res));
    }
    getTask(o:counttask_md){
        return  this.http.post<counttask_md>(environment.urlapiInvt + "/count/getTask/"+this.guid, JSON.stringify(o))
                .pipe( map(res=><counttask_md>res));
    }
    upsertTask(o:counttask_md){
        return  this.http.post(environment.urlapiInvt + "/count/upsertTask/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }
    removeTask(o:counttask_md){
        return  this.http.post(environment.urlapiInvt + "/count/removeTask/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }

    //Plan 
    listPlan(o:counttask_md){
        return  this.http.post<countplan_md[]>(environment.urlapiInvt + "/count/listPlan/"+this.guid, JSON.stringify(o))
                .pipe(
    ...
    getPlan(o:countplan_md){
        return  this.http.post<countplan_md>(environment.urlapiInvt + "/count/getPlan/"+this.guid, JSON.stringify(o))
                .pipe( map(res=><countplan_md>res));
    }
    upsertPlan(o:countplan_md){
        return  this.http.post(environment.urlapiInvt + "/count/upsertPlan/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }
    removePlan(o:countplan_md){
        return  this.http.post(environment.urlapiInvt + "/count/removePlan/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }
    validatePlan(o:countplan_md){ 
        return  this.http.post(environment.urlapiInvt + "/count/validatePlan/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }

    //Line 
    listLineAsync(o:countplan_md){
        return  this.http.post<countline_md[]>(environment.urlapiInvt + "/count/listLine/"+this.guid, JSON.stringify(o))
                .pipe( map(res=><countline_md[]>res));
    }
       //Line 
    countLineAsync(o:countplan_md){
        return  this.http.post<countline_md[]>(environment.urlapiInvt + "/count/countline/"+this.guid, JSON.stringify(o))
                .pipe( map(res=><countline_md[]>res));
    }
    upsertLineAsync(o:countline_md[]){
        return  this.http.post(environment.urlapiInvt + "/count/upsertLine/"+this.guid, JSON.stringify(o))
                .pipe( map(res=>res));
    }

    getcountlist(o:countplan_md): any {		
        let search = new URLSearchParams();
        search.set('orgcode', o.orgcode); search.set('site', o.site); search.set('depot', o.depot); 
        search.set('countcode', o.countcode);search.set('plancode', o.plancode);
        return this.http.post(environment.urlapiDocument +'/print/CountSheet',search.toString(),{responseType:'blob'});
    ...
    listConfirm(o:counttask_md){
        return  this.http.post<countcorrection_md[]>(environment.urlapiInvt + "/count/getConfirmLine/"+this.guid, JSON.stringify(o))
