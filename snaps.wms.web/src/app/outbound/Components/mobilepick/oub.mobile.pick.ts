...
declare var $: any;
@Component({
  selector: 'appoub-mobile-pick',
  templateUrl: 'oub.mobile.pick.html'

})
export class oubmobilepickComponent implements OnInit {
  ...
  ngOnInit(): void { }
  ngOnDestroy(): void { }
  ngAfterViewInit() { this.getstate(); this.gettype(); this.getunit(); this.fnd(); }
