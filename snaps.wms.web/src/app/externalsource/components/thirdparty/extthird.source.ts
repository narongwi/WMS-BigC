...
@Component({
  selector: 'appext-thirdpartysource',
  templateUrl: 'extthird.source.html',
  styles: ['.dgexsource { height:200px !important; } ','.dgexline { height:calc(100vh - 480px) !important; } '] ,
  providers: [
    {provide: NgbDateAdapter,         useClass: CustomAdapter},
    {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}]    
})
export class extthirdpartysource implements OnInit {
  @Input() item: lov;
  ...
  public lsline:exsInbound[] = new Array();
  public lssource:exsFile[] = new Array();
  //public lsthirdparty:exsThirdparty[] = new Array();
  ...
  constructor(private ss:shareService, private sv:externalSourcelService) { this.ss.ngSetup(); this.ngSetup(); this.pm.imptype = "thparty"; }
  ...
  meFnd() { this.sv.findThparty(this.pm).subscribe((res) => {this.lssource = res; if(this.lssource.length > 0) { this.meLine(this.lssource[0]); }});}
  meLine(o:exsFile) { this.sv.getInboundLines(o).subscribe((res) => { this.lsline = res;}); }
