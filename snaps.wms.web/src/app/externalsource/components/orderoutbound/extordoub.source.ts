...
import { exsOutbound } from '../../models/snaps.wms.externalsource.outbound';
import { externalSourcelService } from '../../services/app-external.service';
@Component({
  selector: 'appext-ordoubsource',
  templateUrl: 'extordoub.source.html',
  styles: ['.dgexsource { height:200px !important; } ','.dgexline { height:calc(100vh - 480px) !important; } '] ,
  providers: [
    {provide: NgbDateAdapter,         useClass: CustomAdapter},
    {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}]    
})
export class extordoubsource implements OnInit {
  @Input() item: lov;
  ...
  public lsbarcode:exsOutbound[] = new Array();
  ...
  constructor(private ss:shareService, private sv:externalSourcelService) { this.ss.ngSetup(); this.ngSetup(); this.pm.imptype = "outbound";  }
  ...
  meLine(o:exsFile) { this.sv.getOutboundLines(o).subscribe((res) => { this.lsbarcode = res;}); }
