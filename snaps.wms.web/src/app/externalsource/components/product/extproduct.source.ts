...
@Component({
  selector: 'appext-productsource',
  templateUrl: 'extproduct.source.html',
  styles: ['.dgexsource { height:200px !important; } ','.dgexline { height:calc(100vh - 480px) !important; } '] ,
  providers: [
    {provide: NgbDateAdapter,         useClass: CustomAdapter},
    {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}]    
})
export class extproductsource implements OnInit {
  @Input() item: lov;
  ...
  public lsline:exsProduct[] = new Array();
  public lssource:exsFile[] = new Array();
  //public lsproduct:exsproduct[] = new Array();
  ...
  constructor(private ss:shareService, private sv:externalSourcelService) { this.ss.ngSetup(); this.ngSetup(); this.pm.imptype = "product"; }
  ...
  meFnd() { this.sv.findProduct(this.pm).subscribe((res) => {this.lssource = res; if(this.lssource.length > 0) { this.meLine(this.lssource[0]); }});}
  meLine(o:exsFile) { this.sv.getProductLines(o).subscribe((res) => { this.lsline = res;}); }
