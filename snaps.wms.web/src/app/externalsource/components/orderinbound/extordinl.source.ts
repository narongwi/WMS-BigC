...
@Component({
  selector: 'appext-ordinlsource',
  templateUrl: 'extordinl.source.html',
  styles: ['.dgexsource { height:200px !important; } ','.dgexline { height:calc(100vh - 480px) !important; } '] ,
  providers: [
    {provide: NgbDateAdapter,         useClass: CustomAdapter},
    {provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter}]    
})
export class extordinlsource implements OnInit {
  @Input() item: lov;
  ...
  public lsbarcode:exsInbouln[] = new Array();
  ...
  constructor(private ss:shareService, private sv:externalSourcelService) { this.ss.ngSetup(); this.ngSetup(); this.pm.imptype = "inbouln";  }
  ...
  meLine(o:exsFile) { this.sv.getInboulnLines(o).subscribe((res) => { this.lsbarcode = res;}); }
