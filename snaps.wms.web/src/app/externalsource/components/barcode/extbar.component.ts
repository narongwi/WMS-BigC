...
import { extbarsource } from './extbar.source';

declare var $: any;
@Component({
  selector: 'app-extbarcode',
  templateUrl: 'extbar.component.html',
...
export class extBarcodeComponent implements OnInit,OnDestroy {
