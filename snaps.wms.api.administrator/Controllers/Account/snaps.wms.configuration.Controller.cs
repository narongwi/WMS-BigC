...
namespace Snaps.WMS.Controllers {
    ...
    public class configController : ControllerBase {
        private IconfigService svpl;
        private IaccountService svac;
        private readonly ILogger<policyController> _log;
        private readonly AppSettings _optn;
        private readonly String app = "api.admin.config";
        public configController(ILogger<policyController> logger,IOptions<AppSettings> optn, IconfigService _svpl, IaccountService _svac) { 
            svpl = _svpl; _log = logger; _optn = optn.Value; svac = _svac; }

        [Authorize] [HttpPost("List/{id}")]
        public async Task<IActionResult> findAsync(String id, [FromBody] config_md o, 
        ...
        public async Task<IActionResult> upsertAsync(String id, [FromBody] config_md o, 
                    [FromHeader(Name="site")] String site,
                    [FromHeader(Name="depot")] String depot,
                    [FromHeader(Name="accncode")] String accncode,
                    [FromHeader(Name="accscode")] string accscode,
        ...
        public async Task<IActionResult> dropAsync(String id, [FromBody] config_md o, 
                    [FromHeader(Name="site")] String site,
                    [FromHeader(Name="depot")] String depot,
                    [FromHeader(Name="accncode")] String accncode,
                    [FromHeader(Name="accscode")] string accscode,
